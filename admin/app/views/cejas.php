...
?>
        ...
        <br>
        <h1 class="title text-center mt-4 mb-4">Lista Servicios Cejas</h1>
        <div class="container mb-4">
            <a href="/tatiyvero/admin/index.php?action=agregar&tabla=servicio_cejas" class="btn btn-success ms-auto mt-3">Agregar</a>
        </div>
        <table class="table table-bordered text-center">
            ...
            <tbody>
                <?php
                $sql = "SELECT * FROM servicio_cejas";
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formEditarServicio" method="POST" action="/tatiyvero/admin/index.php?action=editar_servicio">
                ...
                <input type="hidden" id="tabla" name="tabla" value="servicio_cejas"> <!-- Tabla que se está editando -->
