...
?>
        ...
        <h1 class="title text-center mt-4 mb-4">Lista Servicios Uñas</h1>
        <div class="container mb-4">
            <a href="/tatiyvero/admin/index.php?action=agregar&tabla=servicio_uñas" class="btn btn-success ms-auto mt-3">Agregar</a>
        </div>
            ...
            <tbody>
                ...
                foreach ($servicios as $servicio): ?>
                    <tr>
                        ...
                        <td>
                            <!-- Editar Servicio (botón con icono de lápiz) -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formEditarServicio" method="POST" action="/tatiyvero/admin/index.php?action=editar_servicio">
                ...
                <input type="hidden" id="tabla" name="tabla" value="servicio_uñas"> <!-- Tabla que se está editando -->
